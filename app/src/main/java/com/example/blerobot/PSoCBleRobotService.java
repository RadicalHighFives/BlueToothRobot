...
//    }
    ...
    private static final String baseUUID  =            "0F4FA207-B708-404C-819B-164702F66BF";
    ...
    private static final String CCCD_UUID =          "00002902-B708-404C-819B-164702F66BFB";
...
//            if(mSpeedLeftCharacteristic != null && mSpeedRightCharacteristic != null){
//
//                if(state){
...
//        }
    ...
    public void setForwardMotorSpeed(Motor motor, int speedLeft, int speedRight) {
        boolean state;
        if(motor == Motor.FORWARD)
        {
            motorLeftSpeed = speedLeft;
            motorRightSpeed = speedRight;

            state = forwardState;
            Log.d(TAG," "+ state+" "+speedLeft + " "+ speedRight);
            updateGattSpeed(motor, state);
        }
//        else  { // Motor == RIGHT
//            motorRightSpeed = speed;
